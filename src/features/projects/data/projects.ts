...
export const projects = [
  {
    ...
    technologies: ["Prisma ORM", "TypeScript", "React", "MySql"],
    stack: ["App Router", "Design System", "Data Visualization"],
    architecture: "Feature-first, componentes orientados por domínio e uma camada de visualização desacoplada dos dados.",
  ...
  },
  {
    ...
    description: "Uma jornada de compra silenciosa, precisa e construída para reduzir fricção entre descoberta e decisão.",
    ...
    technologies: ["Next.js", "React", "Tailwind CSS", "TypeScript", "PostgreSQL"],
    stack: ["E-commerce", "Responsive UI", "SEO"],
    architecture: "Páginas orientadas por catálogo, componentes reutilizáveis e estados de produto normalizados.",
    role: "Desenvolvedor FullStack · UX UI Design",
    year: "2025",
    images: [],
    github: null,
    demo: null,
  ...
  },
  {
    ...
    subtitle: "Sistemas conectados, operação contínua",
    description: "Uma plataforma para aproximar processos, pessoas e informação em uma única superfície operacional.",
    challenge: "Unificar fluxos fragmentados mantendo permissões, contexto e previsibilidade para diferentes perfis.",
    solution: "Módulos independentes conectados por uma linguagem comum e navegação orientada à tarefa.",
    technologies: ["React", "TypeScript", "REST APIs"],
    stack: ["Modular UI", "Authentication", "Observability"],
    architecture: "Módulos de domínio, contratos tipados e composição de permissões próxima à interface.",
    ...
    featured: true,
    themeColor: "#c4b9aa",
    learnings: "Projetar consistência sem apagar as diferenças entre domínios e necessidades operacionais.",
